...
<!--    <link rel="stylesheet" href="__PUBLIC__/static/lib/css/amazeui.min.css">-->
    ...
    <link rel="stylesheet" href="{:loadResource('plugin/math/css/xc_style.css')}">
...
<header class="am-topbar xx-topbar-math">
    <div class="">
        ...
        <ul class="xx-subject-module">
            ...
            <li class="xx-subject-module-unit active" style="border-top-right-radius: 16px;border-bottom-right-radius: 16px;"><span>2</span>&nbsp;&nbsp;&nbsp;测试报告</li>
            {if $bxbl_is_end eq 1}
...
<!--                        <span>二次根式的乘法</span>
        ...
        <div class="xx-content" id="xx-list">
            <div class="fc-nav scrollspy-nav" data-am-scrollspynav="{offsetTop: 45}" data-am-sticky>
                <div id="xx-learn-status-rate" style="width:220px;height:220px;float: left"></div>
                <span style="position:absolute;top: 20px;font-size:18px ;font-family: 'MicrosoftYaHei';font-weight: bold">答题正答率</span>
...
<div class="xx-continue" onclick="_czc.push(['_trackEvent', '先行测试报告页下一步按钮', '点击', '下一步','5','']);">
    <div class="xx-next">下一步</div>
</div>
  {/if}
