    ...
    <div class="am-u-lg-12 am-u-lg-centered">
        ...
        <div class="am-u-lg-3 xx-subject-wrap">
            <div class="am-u-lg-12 xx-subject">
                <a href="{:url('choose',array('topicId'=>$item.tid))}" target="_self"><img src="{$item.pic_url}"></a>
                <div class="cover-info">
                    <a href="{:url('choose',array('topicId'=>$item.tid))}" target="_self"><h4>{$item.topic_name}</h4></a>
                    <!--                        <small>说明</small>-->
                </div>
