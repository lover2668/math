...
<header class="am-topbar xx-topbar-math">
    <div class="header-title">
        ...
        <ul class="xx-subject-module">
            ...
            <li class="xx-subject-module-unit active" style="border-top-right-radius: 16px;border-bottom-right-radius: 16px;"><span>6</span>&nbsp;&nbsp;&nbsp;模拟测试</li>
...
<script src="{:loadResource('static/math/js/class.mncsQuestion.js')}"></script>
...
<script>
    $(function(){
        ...
        var preIndex   = new MnQuestion( '#question-sheet');
        $("#myEditor").hide();
