...
<style>
    ...
    .imitate-test{
        width: 413px;
        height: 127px;
        background: url(__PUBLIC__/static/math/img/mntest.png) no-repeat;
        position: absolute;
        top: -90px;
        left: 140px;
    }
...
<body>
<input type="hidden" id="module_type"    value="<?php echo config('mncs_module_type'); ?>" />
<div class="wrapper">
    <div class="am-g">
        ...
        <div class="book-img">
            ...
            <div class="target">
                <p>你想提分吗？<br/>这里能帮你取得好成绩！</p>
<!--                <p><span>目标</span> 解决难题，成为学霸</p>-->
<!--                <p><span>目的</span> 挑战难题，提升自我</p>-->
            </div>
            <div class="book-btn">
                <a href="{url link='mncsQuestion' vars='topicId=$topicId'}" type="button" class="am-btn">开始测试</a>
            </div>
        </div>
