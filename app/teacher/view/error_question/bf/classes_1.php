...
<div class="am-cf am-padding am-padding-bottom-0">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">班级错题</strong> / </div>
</div>
...
<div class="am-g">
    ...
    <div class="am-u-sm-9">
        ...
        <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-6 am-thumbnails" id="studentsList" style="height: 250px;overflow: auto">
            ...
            <li onclick="location.href='{:url('person',array('user_id'=>$item.user_id,'course_id'=>$course_id,'class_id'=>$class_id,'topic_id'=>$topic_id,'username'=>$item.user_name,'answered'=>$item.answered))}'">
                <div>
                <span>NO.{$key+1}</span>
                    ...
                    <td>
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                <button onclick="openbatch('{$vo.id}',{$course_id|default=0},'{$class_id|default="0"}')" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><i class="am-icon-file-text-o"></i> 查看</button>
...
<script type="text/javascript">
     ...
     * @param id
     */
    function openbatch(id,course_id,class_id){
        //iframe窗
        var param="?id="+id;
        if(course_id)
        {
