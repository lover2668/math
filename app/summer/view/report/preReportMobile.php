    ...
    <body>
        <div class="container">
                    ...
                    <div class="knowMaster allAnswer">
                        ...
                        <div class="knowMaster-content">
                            <div class="echartsImg">
                                ...
                                <ul>
                                    <li>全部知识点<span>{$knowledge_list_num}个</span></li>
                                    <li>已掌握知识点<span>{$new_knowledgeList_num}个</span></li>
                                    <li>未掌握知识点<span>{$weakElements_num}个</span></li>
                                </ul>
                            </div>
                        ...
                        <div class="footer">
                            <input type="button" value="点击查看题目详情" onclick="location.href = '{:url('Report/reportMobileMathQues',['topicId'=>$topicId,'user_id'=>$user_id,'submodule_type'=>$submodule_type,'batch_num'=>$batch_num,'report_num'=>2])}'"">
            ...
            <script>
                                 ...
                                 var all='{$knowledge_list_num}',
                                     alreadied='{$new_knowledgeList_num}',
                                     master=Math.round((alreadied/all)*100);

                                 var myChart2 = echarts.init(document.getElementById('echartsP'));
                                 option2 = {
                                     //标题组件，包含主标题和副标题。
                                     title: {
                                         text: master+'%',
                                     ...
                                     series: [
                                         {
                                             ...
                                             data: [
                                                 {value: '{$new_knowledgeList_num}', name: '已掌握'},
                                                 {value: '{$weakElements_num}', name: '未掌握'},
                                             ]
                                         }
                                     ]
                                 };
