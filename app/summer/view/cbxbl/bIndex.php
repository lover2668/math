...
<div class="xx-header">
    <div class="xx-navbar">
        ...
        <div class="xx-navbar-left xx-nav">{$topic_name}&nbsp;_&nbsp;综合先行测试&nbsp;_&nbsp;<strong>综合学习</strong></div>
...
<script src="{:loadResource('static/app/math_summer_l2/bxbl/js/class.GxIndex.js')}"></script>
