...
<div class="xx-container">
    ...
    <h1 id="xx-question-type" name="xx-question-type">01&nbsp;填空题</h1>
    ...
    <div class="xx-analyse" name="question-analysis">
        ...
        <div class="xx-audio" style="display: none;">
            <i class="xx-icon">&#xe65a;</i>
...
<script src="{:loadResource('classba/app/math/js/class.SummerAppBasicStudy.js')}"></script>
<script src="{:loadResource('classba/app/math/js/app-basic-study.js')}"></script>
{/block}
