...
<div class="xx-container" style="position: relative">
    ...
    <div class="xx-video-container">
        <p style="padding: 24px 0 16px 40px; font-size:24px;color: #333333;"><strong>基础视频</strong> <span>知识点－{$tag_name}</span></p>
    ...
    <div class="xx-continue" name="xx-continue" style="background-color: transparent">
        <div class="xx-continue-button" style="letter-spacing: 0;padding:0;line-height: 48px;text-align: center" onclick="_czc.push(['_trackEvent', '基础学习视频下一步按钮', '点击', '下一步','5','']);">
            去学习
        </div>
    </div>
</div>
...
<script>
    (function($){
        ...
        $(".xx-continue-button").on("click",function(){
            window.open("http://"+window.location.host+"/index.php/"+"/summer/index/basicStudy/topicId/"+topicId,"_self")
        });
