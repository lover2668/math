...
<div class="xx-container">
    ...
    <h1 id="xx-question-type" name="xx-question-type"></h1>
...
<script src="{:loadResource('classba/app/math/js/class.SummerAppPreIndex.js')}"></script>
<script src="{:loadResource('classba/app/math/js/app-test.js')}"></script>
{/block}
