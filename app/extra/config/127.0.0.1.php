...
//        'session_name' => 'localhost:'// sessionkey前缀
//    ],
//
    ...
    "api_url" => "http://test-algo.classba.cn",//测试机算法服务器
    ...
    "xuexi_module_type" => 5,    // 提供给题库的module   学习检测模块 module_type,正确应该是5,目前测试先用 2.  提交的时候用这个。
...
//    'is_open_testInfo_for_question_content'=>$_SERVER['HTTP_HOST']=='math.classba.com.cn'?true:false,   //控制试题ID和知识点的测试内容是否显示
    'is_open_testInfo_for_question_content'=>true,   //控制试题ID和知识点的测试内容是否显示
    'default_diffculty' => '2',
    'api_server_user'=>'http://api.51yxedu.com/api.php',//天王星老师端api正式接口
    'sys_code'=>1,
    'logo_url'=>'javascript:void(0);',
    'sys_code'=>"2020172001",
    'total_level'=>9,
    'init_kstatus'=>3,
    'new_algo_api_url'=>"http://test-algo.classba.cn",
...
//    'v2_question_server_host'=>"http://api-qb-math.51xstudy.com/",
    'v2_question_server_host'=>"http://dev-qb-api.91xedu.com:8080/math/v2/",  //题库接口
    ...
    "is_open_xhprof"=>false,
    "demo_url"=>"http://test-demo.classba.cn/math/Login/loginIn/token/",
