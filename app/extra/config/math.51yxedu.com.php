...
//    'is_open_testInfo_for_question_content'=>$_SERVER['HTTP_HOST']=='math.classba.com.cn'?true:false,   //控制试题ID和知识点的测试内容是否显示
    ...
    'api_server_user_test'=>'http://api.51yxedu.com/api.php',//测试老师端api测试接口
    'api_server_user_171xue'=>'http://api.171xue.com/api.php',//171xue老师端api接口
    'sys_code'=>1,
    'logo_url'=>'javascript:void(0);',
    '171_url'=>'http://math.171xue.com',
    'demo_url'=>'http://math.classba.cn',
    'sys_code'=>"2020172001",
    'total_level'=>9,
    'init_kstatus'=>3,
    'new_algo_api_url'=>"http://139.196.86.11:8080",
    'new_topic_service_api_url'=>"http://api-topic.51yxedu.com",
    'algo_session_code'=>"algo_session_id",
    'level_mode_1'=>1,
    'l1_module_type'=>8,
    'l1_base_ability_standard'=>0.2,
    ...
    'v2_question_server_host'=>"http://input-math-t.51xonline.com/",
