...
//    ],
    ...
    'session' => [
        ...
        'session_name' => 'math:'// sessionkey前缀
    ],
    // +----------------------------------------------------------------------
    // | Cookie设置
    // +----------------------------------------------------------------------
    ...
    "api_url" => "http://algo.classba.cn",//测试机算法服务器
...
//    'is_open_testInfo_for_question_content'=>$_SERVER['HTTP_HOST']=='math.classba.com.cn'?true:false,   //控制试题ID和知识点的测试内容是否显示
    ...
    'total_level'=>9,
    'init_kstatus'=>3,
    'new_algo_api_url'=>"http://algo.classba.cn",
    ...
    "demo_url"=>"http://demo.classba.cn/math/Login/loginIn/token/",
