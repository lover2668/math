...
//    ],
    ...
    'session' => [
        ...
        'session_name' => 'test_math_online:'// sessionkey前缀
    ],
    ...
    "api_url" => "http://test-algo.171xue.com",//测试机算法服务器
...
//    'is_open_testInfo_for_question_content'=>$_SERVER['HTTP_HOST']=='math.classba.com.cn'?true:false,   //控制试题ID和知识点的测试内容是否显示
    ...
    'default_diffculty' => '2',
    'api_server_user'=>'http://test-api3.171xue.com/api.php',//天王星老师端api正式接口
    'sys_code'=>1,
    'logo_url'=>'javascript:void(0);',
    'sys_code'=>"2020172001",
    'total_level'=>9,
    'init_kstatus'=>3,
    'new_algo_api_url'=>"http://test-algo.171xue.com",
    ...
    "demo_url"=>"http://test-demo.171xue.com/math/Login/loginIn/token/",
