...
MnQuestion.prototype.domReady=function(){
    try{
        var thisObj = this;
        thisObj.getQuestion();
    }catch (err){
...
MnQuestion.prototype.getQuestion=function(){
    try{
        var index = layer.load(0, {shade: 0.8});
        var thisObj = this;
        var topicId=$("input[name=topicId]").val();
        $.ajax({
            url: HOST+"/index/mncs/getExamQuestions",
            data:{
...
//                    });
                    ...
                    window.open(HOST+"index/mncs/mncsReport/topicId/"+topicId,"_self");
                    // $(".xx-next").html("结束");
...
//提交
MnQuestion.prototype.initSubmit=function(topicId,answer_content,start_time){
    try{
        var thisObj = this;
        ...
        $.ajax({
            url: HOST+"/index/mncs/submitQuestion",
            data:{
                topicId: topicId,
 ...
 * 创建提交按钮
 */
MnQuestion.prototype.initSubmitButton = function () {
 ...
 * 初始化题目填空
 */
MnQuestion.prototype.initQuestionInput = function (param) {
    try{
        var content = "";
 ...
 * 初始化题目选项
 */
MnQuestion.prototype.initQuestionOption = function (param) {
    try{
...
// 多选题题目
MnQuestion.prototype.initQuestionOptions=function(param){
    try{
...
MnQuestion.prototype.initCharts = function(){
    $("#xx-time-charts").html("");
 ...
 * 初始化解析
 */
MnQuestion.prototype.initQuestionAnalyse = function (param,type)
{
    try{
...
MnQuestion.prototype.openAnalyse = function(param){
    try{
        if(param=="analyse"){
            var step = 0;
            var $num = 0;
...
// 报错弹框的
MnQuestion.prototype.initErrorOption=function(param){
...
//右侧步骤解析、知识点讲解视频图片
MnQuestion.prototype.initKnOption=function(){
