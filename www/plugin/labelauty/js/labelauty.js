        ...
        function rdochecked(tag) {
            $('.' + tag).each(function (i) {
                ...
                if ($('.' + tag).eq(i).prop("checked") == false) {
                    ...
                    rdobox.find(".check-image").css("background", "url(http://"+window.location.host+"/plugin/lib/labelauty/images/input-unchecked.png)");
                    ...
                    rdobox.find(".check-image").css("background", "url(http://"+window.location.host+"/plugin/lib/labelauty/images/input-checked.png)");
                    rdobox.find(".check-image").addClass("unchecked");
                }
            });
        }
