...
(function ($) {
    if($.fn.ajaxForm == undefined) {
        $.getScript("http://"+window.location.host+"/plugin/lib/uploadfile/js/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var uploadLabel = $('<div class="am-btn am-btn-danger am-btn-sm xx-plus"><i class="xx-am-icon-plus"></i></div>');
        ...
        (function checkAjaxFormLoaded() {
            if($.fn.ajaxForm) {
                ...
                if(s.dragDrop) {
                    ...
                    // $(dragDrop).append("<span style=''>未选择任何文件，插入题目错误截图可以更好地帮助你反馈错误</span>");
