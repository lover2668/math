!function (e, t) {
    ...
    _.open(function (e, t) {
        ...
        Q.p.substituteTextarea = function () {
            return q("<textarea autocapitalize=off autocomplete=off autocorrect=off spellcheck=false x-palm-disable-ste-all=true />")[0]
            ...
            $(e.Data.toolbar).each(function () {
                if (this.symbol.length) {
                    ...
                    $(this.symbol).each(function () {
                        var t = this;
                        $("<img src='/static/assets/wangEditor/src/images/formula/" + this.img + "'>").appendTo(e).click(function () {
                            r.write(t.latex)
                        })
                    }), $("<div class='fe-symbol'><img src='/static/assets/wangEditor/src/images/formula/" + this.img + "'><br>" + this.className + "</div>").appendTo(s).append(e)
                }
            });
