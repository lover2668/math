...
!function (e) {
    var t = function () {
        ...
        return t.render = function (t, n) {
            ...
            return $('<button class="btn btn-submit">确定</button>').appendTo(o).click(function () {
                n.handlers.completed && n.handlers.completed(r.latex())
            }), $('<button class="btn btn-cancel" style="display: none">取消</button>').appendTo(o).click(function () {
