...
SummerAppBackIndex.prototype.getQuestion = function () {
    try{
        ...
        $.ajax({
            url: $url_config.get_bt_exam_question,
            data: {
                topicId:topicId
            },
            type: 'POST',
...
SummerAppBackIndex.prototype.initSubmit = function (topicId, answer_content,start_time) {
    try{
        ...
        $.ajax({
            url: $url_config.submit_bt_exam_questions,
            data: {
                topicId: topicId,
                user_id:$_CONFIG.uid,
...
SummerAppBackIndex.prototype.createDomContinue = function (times) {
    try{
        var thisObj = this;
        $("[name='xx-continue']").html('<hr/><div name="continue" class="xx-continue-button" onclick="_czc.push([&apos;_trackEvent&apos;, &apos;先行测试提交点击按钮&apos;, &apos;点击&apos;, &apos;提交&apos;,&apos;5&apos;]);">提交 </div>');
